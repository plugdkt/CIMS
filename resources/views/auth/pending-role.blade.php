...
@section('title', __('auth.pending_role_title'))
...
@section('content')
    <div class="text-center">
        ...
        <h1 class="font-display text-lg font-bold mb-2">{{ __('auth.pending_role_title') }}</h1>
        <p class="text-sm text-ink-muted leading-relaxed mb-4">{{ __('auth.pending_role_body') }}</p>
